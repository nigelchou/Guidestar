    ...
    for img_num in range(num_imgs):
        ...
        if microscope_type in ["Dory", "Nemo"]:
            ...
            # but not if there are 2
               ...
               # check that the tiff being read has 4 dimensions
            if tiff_img.ndim == 4: 
                
                temp_image = tiff_img[z_slice, ..., tiff_frame]
...
def extractzandsave(tiff_img_path, z):
    
    
    tiff_img = skimage.io.imread(tiff_img_path)
