...
### Assign BFS ###
save_coord_path = coord_cache_path  + '/coords_cache_BFS_assigned_extendedmisid'
...
spot = generate_BFS_coord_extendedmisid(coord_cache_path,
                                        fpkm_path,
...
colocalisation_counts_df.to_csv(os.path.join(output_path, dataset_name + '_Colocalisation_counts_extendedmisid.csv'))
...
GS_training_df.to_csv(os.path.join(output_path, dataset_name + '_GuidestarGenes_training_extendedmisid.csv'))
...
Allgenes_Merfish_df.to_csv(os.path.join(output_path, dataset_name + '_MerfishData_extendedmisid.csv'))