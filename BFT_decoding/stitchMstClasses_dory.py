...
from writeClasses import DaxWriter
...
class Stitch(object):
    ...
    def __init__(self,
                 ...
                 # scaling factors for are in num pixels per micron - equivalent to 130 nm / pixel
    ...
    def combineSpots(self,
        ...
        with h5py.File(combined_filepath, "a") as combined_h5:
