...
data_path = filedialog.askdirectory(title="Please select data directory") # your raw folder path containing 100uM cells
...
user_params['fovs_to_process'] = list(range(25)) # dory
